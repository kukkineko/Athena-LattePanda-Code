...
export declare function min<T>(array: readonly [T, ...(T | undefined)[]]): T;
export declare function min<T>(array: readonly T[], compare?: (a: T, b: T) => number): T | undefined;
export declare function max<T>(array: readonly [T, ...(T | undefined)[]]): T;
export declare function max<T>(array: readonly T[], compare?: (a: T, b: T) => number): T | undefined;
export declare function compact<T>(array: readonly (T | undefined)[]): T[];
